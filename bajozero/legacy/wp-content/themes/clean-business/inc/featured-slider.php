...
function clean_business_demo_slider() {
	return '
		<div class="slide-item" style="background-image:url(\''. get_template_directory_uri() .'/images/gallery/slider1-1920x1280.jpg\')">
	    ...
	    <div class="slide-item" style="background-image:url(\''. get_template_directory_uri() .'/images/gallery/slider2-1920x1280.jpg\')">
			<div class="slide-inner">
	            <div class="contain animated fadeInRightBig text-slider">
