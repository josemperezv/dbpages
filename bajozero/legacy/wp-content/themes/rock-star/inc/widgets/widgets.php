...
function rock_star_widgets_scripts( $hook) {
	if ( 'widgets.php' == $hook ) {
		wp_enqueue_style( 'rock-star-widgets-styles', get_template_directory_uri() . '/css/widgets.css' );

		wp_enqueue_media();

		wp_enqueue_script( 'rock-star-widgets-scripts', get_template_directory_uri() . '/js/widget.min.js', array( 'jquery', 'jquery-ui-datepicker' ) );
	}
}
