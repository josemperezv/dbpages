...
class rock_star_background_image_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( '' != $image ) {
			...
			echo '<span class="divider"><img src=" ' . get_template_directory_uri() . '/images/gallery/divider-1920x156.png" alt="divider"></span>
                <span class="background-image" style="background-image: url('. esc_url( $image ) .'); '. $height . $padding . '"></span>
				<span class="divider"><img src=" ' . get_template_directory_uri() . '/images/gallery/divider-1920x156.png" alt="divider"></span>';
...
add_action( 'widgets_init',
	create_function( '', 'return register_widget("rock_star_background_image_widget");')
);