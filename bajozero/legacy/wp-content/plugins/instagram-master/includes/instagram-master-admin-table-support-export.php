...
include_once($_SERVER['DOCUMENT_ROOT'].'/wp-load.php' );
	...
	$plugin_master_version = constant('INSTAGRAM_MASTER_VERSION');
	...
	if( is_multisite() ){
		...
		$license = get_blog_option($blog_id, 'instagram_license_key');
		$status = get_blog_option($blog_id, 'instagram_license_status' );
		$status_error = get_blog_option($blog_id, 'instagram_license_error' );
		$license_expires = get_blog_option($blog_id, 'instagram_license_expires' );
		...
		$license = get_option('instagram_license_key');
		$status = get_option( 'instagram_license_status' );
		$status_error = get_option( 'instagram_license_error' );
		$license_expires = get_option( 'instagram_license_expires' );
