...
if ( is_admin() )
add_menu_page( 'Instagram Master', 'Instagram Master', 'manage_options', 'instagram-master', 'instagram_master_admin', plugins_url( 'instagram-master/images/techgasp-minilogo-16.png' ) );
}
		///////////////////////
		// WORDPRESS ACTIONS //
		///////////////////////
...
if(!class_exists('instagram_master_admin_table_header')){
	require_once( dirname( __FILE__ ) . '/instagram-master-admin-table-header.php');
}
...
if(!class_exists('instagram_master_admin_table_news')){
	require_once( dirname( __FILE__ ) . '/instagram-master-admin-table-news.php');
}
//Prepare Table of elements
...
<?php
if(!class_exists('instagram_master_admin_table_support')){
	require_once( dirname( __FILE__ ) . '/instagram-master-admin-table-support.php');
}
//Prepare Table of elements
$wp_list_table = new instagram_master_admin_table_support();
//Table of elements
$wp_list_table->display();
