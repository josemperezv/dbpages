...
//Display View on Instagram Button
	...
	if ( $show_instagrambutton_small ){
		...
		if(empty($instagram_master_system_wide_username)){
			...
			'<a href="https://instagram.com/'.$instagram_master_system_wide_username.'?ref=badge" class="ig-b- ig-b-24"><img src="//badges.instagram.com/static/images/ig-badge-24.png" alt="Instagram" /></a>';
		}
	}
	else{
		if(is_multisite()){
		...
		if(empty($instagram_master_system_wide_username)){
			...
			'<a href="https://instagram.com/'.$instagram_master_system_wide_username.'?ref=badge" class="ig-b- ig-b-v-24" target="_blank"><img src="//badges.instagram.com/static/images/ig-badge-view-24.png" alt="Instagram" /></a>';
		}
	}
