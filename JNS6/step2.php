<?php include_once('header.php'); ?>
  <body>
    ...
    <div class="container order-options">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="order-options-title">SELECTED ARTICLE</div>
      ...
      <div class="form-row options">
        <div class="option-text">
          <input type="text" class="subject" id="subject" placeholder="Keywords">
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="options">
          <select class="form-control images" id="SubjectSelection">
            <option>Yes</option>
      ...
      <div class="form-row">
        <div class="options">
          <textarea class="form-control description" id="DescriptionArea" rows="3"></textarea>
        </div>
      </div>
